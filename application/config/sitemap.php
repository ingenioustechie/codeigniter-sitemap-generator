...
$config['auth_override_class_method']['auth']['encrypt'] 			 			= 'none';
$config['auth_override_class_method']['auth']['decrypt'] 			 			= 'none';
...
$config['auth_override_class_method']['user']['notification'] 	= 'none';
$config['auth_override_class_method']['key']['index'] 				= 'none';


$config['auth_override_class_method']['dataupload']['uploadImage'] 				= 'none';
